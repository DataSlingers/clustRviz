...
vignette: >
  %\VignetteIndexEntry{clustRviz Tutorial}
...
solution paths an easy process. In the [QuickStart](1-QuickStart.html)
...
weights. More details are available in the [Weights vignette](4-Weights.html)
